...
namespace TSOClient.LUI
{
    ...
    class UICitySelectionDialog : NetworkedUIElement
    {
            ...
            DrawLevel.DontGiveAFuck)
        {
            ...
            Texture2D CityDescBackroundTex = Texture2D.FromStream(Screen.ScreenMgr.GraphicsDevice, TexStream);
            ...
            Texture2D CityImgTex = Texture2D.FromStream(Screen.ScreenMgr.GraphicsDevice, TexStream);
            ...
            Texture2D BtnTex = Texture2D.FromStream(Screen.ScreenMgr.GraphicsDevice, TexStream);
